...
exports.Browsers = {
    ubuntu: browser => ['Windows', browser, '7.1.0'],
    macOS: browser => ['Windows', browser, '5.1.1'],
    baileys: browser => ['Windows', browser, '8.0.0'],
    /** The appropriate browser based on your OS & release */
    appropriate: browser => [PLATFORM_MAP[(0, os_1.platform)()] || 'Windows', browser, (0, os_1.release)()]
};
exports.BufferJSON = {
    replacer: (k, value) => {
...
const generateMessageID = () => 'PVMD' + (0, crypto_1.randomBytes)(16).toString('hex').toUpperCase();
